...
- **令和8年第2回定例会（6月25日議決分）の議員別賛否**：2026-07-01にPDF（ファイル名：20260525sanpi.pdf）が公式サイトに公開されたため`data/gikai-votes/2026-06-25.json`を作成・反映済み。`verified: false`のまま（公式PDFを直接読み取って転記したが、二次照合は未実施）。確認URL: `https://www.city.takarazuka.hyogo.jp/1060687/gikai/katsudo/1000795/1041633/index.html`
- **令和8年第3回定例会（9月定例会）の日程確定**：令和8年9月1日〜10月7日（37日間）。9月以降の更新作業で議案情報・議員別賛否を追跡する。
